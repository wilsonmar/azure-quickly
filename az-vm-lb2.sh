...
# This is ./az-vm-lb2.sh within https://github.com/wilsonmar/azure-your-way
...
#    bash -c "$(curl -fsSL https://raw.githubusercontent.com/wilsonmar/azure-your-way/master/az-vm-lb2.sh)" -v -i
